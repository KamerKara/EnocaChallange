    ...
    public partial class kamer : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompanyOrder", x => new { x.CompaniesId, x.OrdersId });
                    table.ForeignKey(
                        name: "FK_CompanyOrder_Companies_CompaniesId",
                        column: x => x.CompaniesId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CompanyOrder_Orders_OrdersId",
                        column: x => x.OrdersId,
